...
export const TIA_PROGRAM: Program = {
    ...
    longDescription: "<p>Domina la inteligencia artificial desde cero con <strong>TRENNO IA</strong>, el programa de entrenamiento intensivo diseñado para líderes y sus equipos. A lo largo de <strong>2 módulos</strong> y <strong>más de 20 lecciones en video</strong>, vas a aprender a diseñar prompts de élite, personalizar ChatGPT para tu negocio y convertir la IA en tu aliada estratégica más poderosa.</p><p>Desde los fundamentos del <strong>Prompt Engineering</strong> — donde vas a dominar la estructura de 6 pasos para crear instrucciones precisas — hasta la <strong>personalización avanzada de ChatGPT</strong> por áreas de negocio (marketing, ventas, liderazgo), cada lección está diseñada para que implementes inmediatamente lo aprendido.</p><p>Vas a aprender a asignar roles expertos a la IA, diseñar fórmulas como <strong>RACS</strong> y <strong>RODOIR</strong> para delegar tareas complejas, explorar tipologías de prompts y dominar la interfaz completa de ChatGPT como un profesional. No es teoría: es entrenamiento práctico con actividades calificadas, recompensas en XP y feedback real.</p><p>Al finalizar, no solo habrás dominado las herramientas de IA más potentes del mercado, sino que habrás desarrollado un <strong>criterio profesional</strong> para diseñar instrucciones que multipliquen la productividad de todo tu equipo.</p>",
    logo: tia_logo,
            ...
            modules: [
                {
                    ...
                    lessons: [
                        ...
                        { id: "TIAM01L04", title: "Ingeniería de Instrucciones: Cómo dejar de 'Preguntar' y empezar a 'Comandar'", longTitle: "Ingeniería de Instrucciones: Cómo dejar de 'Preguntar' y empezar a 'Comandar' - Dominio de PROMPTS | TRENNO IA", description: "<p>Un monoplaza de Fórmula 1 es inútil sin un piloto que sepa cuándo acelerar y cuándo frenar. En esta lección fundamental del programa <strong>TRENNO iA</strong>, dejamos de ser simples usuarios para convertirnos en diseñadores estratégicos. El <strong>Diseño de Prompts</strong> es tu volante: el arte de comunicarte con la IA con la precisión de un campeón para obtener resultados que otros ni siquiera imaginan.</p><h3>¿Qué vas a resolver en esta lección?</h3><p>Pasaremos de la teoría a la ejecución práctica para que domines el <strong>Dominio #1</strong> de la Inteligencia Artificial:</p><ul><li><strong>Definición del Prompt Perfecto:</strong> Entiende por qué el prompt es la herramienta más poderosa de control y cómo usarla para dirigir la máquina con autoridad.</li><li><strong>Las 4 Claves del Mando:</strong> Descubre los factores que condicionan cada respuesta, incluyendo la forma de escritura, el uso de <strong>Roles</strong>, el historial de conversación y las instrucciones personalizadas.</li><li><strong>De la Petición a la Orden:</strong> Ejercicio en vivo para transformar una pregunta simple de novato en un comando estratégico de élite.</li><li><strong>Eliminación de Errores:</strong> Aprende a identificar por qué la IA falla y cómo refinar tus instrucciones para obtener respuestas exactas, rápidas y accionables.</li></ul><p>El prompt es el puente entre tu intención y el poder infinito de la máquina. Prepárate para dar las órdenes que te llevarán directo a la victoria en <strong>STANNUM Game</strong>.</p>", duration: 497, muxPlaybackId: muxPlaybackIds["TIAM01L04"] ?? "" },
                        { id: "TIAM01L05", title: "La Fórmula Maestra: Estructura de 6 Pasos (A-F) para Prompts de Élite", longTitle: "La Fórmula Maestra: Estructura de 6 Pasos (A-F) para Prompts de Élite - Dominio de PROMPTS | TRENNO IA", description: "<p>¿Tus respuestas de IA son mediocres o muy técnicas? El problema no es la máquina, es la falta de estructura en tu instrucción. En esta sesión de entrenamiento intensivo de <strong>TRENNO iA</strong>, desbloqueamos la metodología de 6 pasos que te permitirá diseñar PROMPTs con la precisión de un estratega profesional.</p><h3>La Anatomía del Prompt Perfecto: El Método A-F</h3><p>Para obtener resultados excepcionales, aprenderás a combinar estas 6 variables fundamentales:</p><ul><li><strong>A - Sustantivo Clave / Tema:</strong> Define el núcleo central y el campo de juego de la IA.</li><li><strong>B - Verbo / Intención:</strong> Establece la acción directa (analizar, crear, resumir) para marcar la jugada.</li><li><strong>C - Rol:</strong> Asigna una posición experta (ej. Profesor de primaria) para cambiar radicalmente el tono y la profundidad.</li><li><strong>D - Forma / Salida:</strong> Diseña el formato de victoria (un cuento, una tabla, un correo o un análisis).</li><li><strong>E - Contexto Infinito:</strong> Proporciona detalles específicos para eliminar improlijidades y reducir el margen de error.</li><li><strong>F - Adjetivo:</strong> Añade estilo y personalidad (creativo, dramático, profesional) para un acabado perfecto.</li></ul><h3>Dominio de la Iteración y Control de Interfaz</h3><p>No te conformes con la primera respuesta. Descubre cómo usar las herramientas avanzadas de la cabina de control:</p><table><thead><tr><th>Herramienta</th><th>Utilidad Táctica en STANNUM Game</th></tr></thead><tbody><tr><td><strong>Edición con el 'Lápiz'</strong></td><td>Permite corregir y optimizar el prompt original sin ensuciar el historial.</td></tr><tr><td><strong>Historial de Versiones</strong></td><td>Navega entre diferentes respuestas (1/3, 2/3) para comparar resultados de distintos modelos.</td></tr><tr><td><strong>Gestión del Historial</strong></td><td>Aprende a renombrar y organizar tus chats para evitar la acumulación de hilos genéricos.</td></tr></tbody></table><p>Con esta lección, dejarás de ser un espectador para convertirte en un jugador clave capaz de <strong>comandar la Inteligencia Artificial</strong> hacia objetivos de alto rendimiento.</p>", duration: 585, muxPlaybackId: muxPlaybackIds["TIAM01L05"] ?? "" },
                        { id: "TIAM01L06", title: "Dominio de la Cabina: Tour Profesional por las Funciones de ChatGPT", longTitle: "Dominio de la Cabina: Tour Profesional por las Funciones de ChatGPT - Dominio de PROMPTS | TRENNO IA", description: "<p>Un piloto de alto rendimiento conoce cada botón de su tablero. En esta lección exploramos el <strong>ecosistema completo de ChatGPT</strong> para que aproveches las herramientas de gestión que disparan tu productividad y profesionalismo en STANNUM Game.</p><h3>Optimización del Espacio de Trabajo</h3><p>Descubre cómo configurar tu entorno para un enfoque total y una gestión de datos eficiente:</p><ul><li><strong>Gestión de Historial:</strong> Aprende a renombrar, archivar y organizar tus chats en el panel lateral para evitar la acumulación de hilos genéricos y facilitar la búsqueda de información.</li><li><strong>Chat Temporal:</strong> Utiliza el modo incógnito para consultas rápidas que no quieres que afecten el entrenamiento o la <strong>Memoria</strong> de tu IA.</li><li><strong>Selector de Modelos:</strong> Cuándo alternar entre <strong>GPT-4o</strong> y modelos de <strong>Razonamiento Avanzado</strong> (o3, o3-pro) según la complejidad de la tarea.</li><li><strong>Biblioteca de Imágenes:</strong> Accede y gestiona visualmente todo el contenido generado por DALL-E desde un solo lugar.</li></ul><h3>Configuración Avanzada y Personalización</h3><table><thead><tr><th>Sección</th><th>Utilidad Táctica</th></tr></thead><tbody><tr><td><strong>Personalización</strong></td><td>Acceso a <strong>Instrucciones Personalizadas</strong> y administración de fragmentos de memoria guardada.</td></tr><tr><td><strong>Controles de Datos</strong></td><td>Opciones para mejorar el modelo y gestionar enlaces compartidos con tu equipo.</td></tr><tr><td><strong>Conectores</strong></td><td>Integración estratégica con <strong>Google Drive</strong>, OneDrive y herramientas de búsqueda web.</td></tr><tr><td><strong>Audio y Voz</strong></td><td>Configuración de la interfaz conversacional para interactuar mediante dictado y respuestas habladas.</td></tr></tbody></table><p>Dominar la interfaz es el paso definitivo para dejar de 'chatear' y empezar a <strong>operar la máquina</strong> con un criterio de experto.</p>", duration: 434, muxPlaybackId: muxPlaybackIds["TIAM01L06"] ?? "" },
...
export const TIA_SUMMER_PROGRAM: Program = {
    ...
    purchasable: true,
    categories: ["main"],
    description: "La pretemporada de verano para arrancar el año al máximo nivel. Entrenamiento intensivo en inteligencia artificial con sesiones en vivo, opción presencial y online.",
    learningPoints: [
        "Diseñar prompts profesionales con la estructura de 6 pasos (A-F)",
        "Dominar la interfaz completa de ChatGPT como un experto",
        "Personalizar ChatGPT con la información clave de tu negocio",
        ...
        "Asignar roles expertos a la IA para obtener resultados específicos",
        "Explorar tipologías de prompts y técnicas de iteración avanzada",
        "Sesiones en vivo con opción presencial y online",
        "Acceso a grabaciones de todas las sesiones en la plataforma",
    ],
    longDescription: "<p><strong>TRENNO IA SUMMER</strong> es la pretemporada de verano de STANNUM Game: un entrenamiento intensivo en inteligencia artificial diseñado para que arranques el año al máximo nivel. Combiná <strong>sesiones en vivo</strong> (con opción presencial y online) con el acceso completo a la plataforma donde vas a encontrar las grabaciones de cada sesión, material de soporte y ejercicios prácticos.</p><p>A lo largo del programa vas a dominar el <strong>Prompt Engineering</strong>, la <strong>personalización de ChatGPT</strong> por áreas de negocio, fórmulas como <strong>RACS</strong> y <strong>RODOIR</strong> para delegar tareas, y mucho más. Todo con acompañamiento en vivo y la posibilidad de consultar dudas en tiempo real.</p><p>Cada módulo incluye material descargable: presentaciones, plantillas de prompts, documentos de referencia y ejercicios de consolidación para que apliques todo directamente en tu negocio. La plataforma queda disponible para que revises el contenido a tu ritmo después de cada sesión.</p>",
...
export const TIA_POOL_PROGRAM: Program = {
    ...
    purchasable: false,
    categories: ["main"],
    description: "Entrenamiento intensivo en inteligencia artificial con sesiones en vivo, opción presencial y online. Dominá la IA con acompañamiento real.",
    learningPoints: [
        "Diseñar prompts profesionales con la estructura de 6 pasos (A-F)",
        "Dominar la interfaz completa de ChatGPT como un experto",
        "Personalizar ChatGPT con la información clave de tu negocio",
    ...
    longDescription: "<p><strong>TRENNO IA POOL</strong> es el programa de entrenamiento intensivo en inteligencia artificial de STANNUM Game con <strong>sesiones en vivo</strong>. Combiná la experiencia de aprender en tiempo real (con opción presencial y online) con el acceso completo a la plataforma donde vas a encontrar las grabaciones de cada sesión, material de soporte y ejercicios prácticos.</p><p>A lo largo del programa vas a dominar el <strong>Prompt Engineering</strong>, la <strong>personalización de ChatGPT</strong> por áreas de negocio, fórmulas como <strong>RACS</strong> y <strong>RODOIR</strong> para delegar tareas, y mucho más. Todo con acompañamiento en vivo y la posibilidad de consultar dudas en tiempo real.</p><p>Cada módulo incluye material descargable: presentaciones, plantillas de prompts, documentos de referencia y ejercicios de consolidación para que apliques todo directamente en tu negocio. La plataforma queda disponible para que revises el contenido a tu ritmo después de cada sesión.</p>",
    logo: tia_pool_logo,
            ...
            modules: [
                {
                    ...
                    description: "Aprende a dominar y redactar PROMPTs como un profesional.",
                    lessons: [
                        { id: "TIAPM01L01", title: "El Mapa Definitivo para Dominar la Inteligencia Artificial y Multiplicar tu Productividad", longTitle: "El Mapa Definitivo para Dominar la Inteligencia Artificial y Multiplicar tu Productividad - Dominio de PROMPTS | TRENNO IA", description: "<p>¿Sientes que solo estás \"jugando\" con la Inteligencia Artificial en lugar de usarla para obtener resultados reales? En esta lección fundamental del programa <strong>TRENNO iA</strong>, te mostramos cómo pasar de ser un simple usuario a convertirte en un \"piloto de Fórmula 1\" de la IA, capaz de dominar la máquina para facilitar tu trabajo, tomar decisiones más rápidas y hacer que tu equipo sea exponencialmente más productivo.</p><h3>En este video descubrirás la hoja de ruta esencial: Los 5 Dominios de la IA</h3><p>Dominar la inteligencia artificial no es un concepto abstracto, sino un camino estructurado. Te guiamos a través de las 5 áreas clave que necesitas controlar:</p><ol><li><strong>Ser Diseñador de Prompts:</strong> Aprende la habilidad número uno del mercado laboral actual. No se trata solo de preguntar, sino de dar instrucciones precisas para obtener resultados poderosos.</li><li><strong>Saber Personalizar:</strong> Descubre cómo alimentar a la IA con tus propios datos para adaptar un chat, un GPT o un proyecto completo a las necesidades de tu negocio, procesos o clientes.</li><li><strong>Funciones Avanzadas:</strong> Ve más allá del chat básico y aprovecha las herramientas avanzadas que ofrecen los grandes modelos de lenguaje como ChatGPT para simplificar tareas complejas.</li><li><strong>Ser Entrenador de GPTs:</strong> Conviértete en un creador. Te enseñamos a entrenar tus propias versiones personalizadas de IA para que actúen como asistentes expertos en diferentes áreas de tu vida y trabajo.</li><li><strong>Automatización con IA:</strong> El nivel máximo de dominio. Aprende a utilizar la IA para crear automatizaciones que multipliquen tu capacidad operativa y la de tu equipo, liberando tiempo para lo que realmente importa.</li></ol><h3>Objetivos para una implementación exitosa</h3><p>Además, establecemos los objetivos prácticos que guiarán tu viaje en la implementación de la inteligencia artificial en tu día a día:</p><ul><li>Naturalizar la utilización de la IA en tu trabajo diario.</li><li>Desarrollar un criterio personal fuerte para el desarrollo de PROMPTs.</li><li>Iterar en la interacción con la IA hasta conseguir el resultado deseado.</li><li>Aprender a EXTRAER y CURAR las respuestas para ser utilizadas en la vida real.</li></ul><p>Este video es tu punto de partida para entender la máquina y, finalmente, dominarla. Prepárate para iniciar tu entrenamiento en STANNUM Game.</p>", duration: 347, muxPlaybackId: muxPlaybackIds["TIAM01L01"] ?? "" },
                        { id: "TIAPM01L02", title: "El \"Motor\" de la IA al Descubierto: Domina los 5 Conceptos que te Harán un Experto", longTitle: "El \"Motor\" de la IA al Descubierto: Domina los 5 Conceptos que te Harán un Experto - Dominio de PROMPTS | TRENNO IA", description: "<p>Para dominar la Inteligencia Artificial, primero debes entender cómo funciona su 'motor'. Al igual que un piloto de Fórmula 1 conoce cada componente de su vehículo para llevarlo al límite, en esta lección del programa <strong>TRENNO iA</strong> desglosamos la tecnología que impulsa a herramientas como ChatGPT. Deja de usar la IA a ciegas y empieza a controlarla con conocimiento.</p><h3>¿Qué aprenderás en esta lección clave?</h3><p>Te explicamos de manera sencilla y directa los 5 conceptos fundamentales que forman la base de la inteligencia artificial moderna. Entenderlos es el primer paso para dejar de ser un aficionado y convertirte en un profesional.</p><ul><li><strong>Deep Learning (Aprendizaje Profundo):</strong> Descubre cómo la IA imita el aprendizaje del cerebro humano a través de \"capas profundas\" de procesamiento para reconocer patrones complejos.</li><li><strong>GPT (Transformador Generativo Preentrenado):</strong> Desglosamos el acrónimo que define a ChatGPT. Entenderás qué significa que sea 'Generativo', por qué su 'Preentrenamiento' es clave y cómo la arquitectura 'Transformer' revolucionó el campo.</li><li><strong>RNA (Redes Neuronales Artificiales):</strong> Visualiza las estructuras inspiradas en las neuronas de nuestro cerebro que permiten a la IA procesar información y aprender.</li><li><strong>LLM (Gran Modelo de Lenguaje):</strong> Comprende qué es exactamente un 'Large Language Model' y por qué modelos como ChatGPT o Gemini pertenecen a esta categoría de gigantes tecnológicos.</li><li><strong>NLP (Procesamiento del Lenguaje Natural):</strong> Conoce el campo de la IA que permite a las máquinas entender, interpretar y responder a nuestro lenguaje, haciendo posible la interacción que hoy experimentas.</li></ul><h3>De la teoría a la práctica</h3><p>A través de analogías claras, como la diferencia entre un atleta amateur (ChatGPT 3.5) y un atleta olímpico con todo un equipo de soporte (ChatGPT 4o), te ayudamos a visualizar por qué el 'entrenamiento' y la 'arquitectura' de un modelo son tan importantes.</p><p>Esta lección es esencial en tu camino para dominar la Inteligencia Artificial. ¡Prepárate para encender el motor y tomar el control en STANNUM Game!</p>", duration: 347, muxPlaybackId: muxPlaybackIds["TIAM01L02"] ?? "" },
                        { id: "TIAPM01L03", title: "El Volante de la IA: Cómo Diseñar Prompts para Obtener Resultados Perfectos", longTitle: "El Volante de la IA: Cómo Diseñar Prompts para Obtener Resultados Perfectos - Dominio de PROMPTS | TRENNO IA", description: "<p>¿Sientes que tus conversaciones con la IA son superficiales y no obtienes la respuesta que buscas? La mayoría de las personas usan ChatGPT como un simple buscador, pero su verdadero poder se desata cuando aprendes a darle <strong>instrucciones precisas</strong>. En esta lección del programa <strong>TRENNO iA</strong>, te enseñamos a tomar el control del \"volante\" de la inteligencia artificial.</p><h3>¿Qué es el Diseño de Prompts y por qué es la habilidad clave?</h3><p>El diseño de prompts (o <em>Prompt Engineering</em>) es el arte y la ciencia de crear las instrucciones perfectas para guiar a la IA. Es el primer dominio que debes conquistar para dominar la tecnología.</p>    <h3>En este video aprenderás a:</h3><ul><li><strong>Entender qué es un Prompt:</strong> Mucho más que una pregunta, es la instrucción que define el éxito o el fracaso de tu interacción.</li><li><strong>Identificar los 4 factores que influyen en la respuesta de la IA:</strong> Descubre cómo la forma en que escribes, el historial de la conversación, la memoria de la IA y las instrucciones personalizadas condicionan cada resultado.</li><li><strong>Aplicar la técnica de asignación de roles:</strong> A través de un ejercicio práctico, verás cómo un simple cambio en el prompt (como pedirle a la IA que \"actúe como un profesor de primaria\") transforma una respuesta técnica en una explicación clara y didáctica.</li><li><strong>Distinguir entre el sustantivo y el verbo de tu prompt:</strong> Aprende a estructurar tus peticiones dividiéndolas en el tema central (parte A) y la acción que deseas (parte B) para lograr una comunicación efectiva.</li></ul><p>Deja de usar la IA como si fuera Google. Después de esta lección, sabrás cómo dirigirla para que trabaje para ti con la precisión de un experto. ¡Es hora de empezar a diseñar en STANNUM Game!</p>", duration: 555, muxPlaybackId: muxPlaybackIds["TIAM01L03"] ?? "", blocked: true },
                        { id: "TIAPM01L04", title: "Introducción al DISEÑO de PROMPTS - Parte 1", longTitle: "Introducción al DISEÑO de PROMPTS - Parte 1 - Dominio de PROMPTS | TRENNO IA", description: "Ya conoces la máquina y entiendes su potencial. Ahora, es momento de tomar el volante. Un monoplaza de Fórmula 1 puede ser el más rápido, pero sin un piloto que sepa exactamente cómo, cuándo y dónde dar cada instrucción, nunca cruzará la línea de meta en primer lugar. El Diseño de Prompts es tu volante, tu acelerador y tus frenos: es el arte de comunicarte con la IA con la precisión de un campeón. <br/> Este video se enfoca en el Dominio #1, la habilidad más crucial para convertirte en un verdadero experto. Aquí es donde separas a los espectadores de los pilotos de élite. No se trata solo de hacer preguntas, se trata de dar órdenes, de diseñar la instrucción perfecta para obtener el resultado exacto que necesitas.<br/> En esta sesión de entrenamiento práctico, aprenderás a:<br/> Definir el Prompt Perfecto: Descubre qué es realmente un prompt y por qué es la herramienta más poderosa para dirigir la IA.<br/> Las 4 Claves del Mando: Entenderás las cuatro influencias fundamentales que condicionan cada respuesta de la IA, desde la forma en que escribes hasta el uso de roles e historial.<br/> De la Petición a la Orden: Te mostraremos en vivo cómo transformar una pregunta simple en un comando estratégico que te entregue resultados superiores, más rápidos y más precisos.<br/> Evitar los Errores de Novato: Aprende a identificar por qué la IA no te da lo que quieres y cómo refinar tus instrucciones para que te entienda a la perfección.<br/> El prompt es el puente entre tu intención y el poder de la máquina. Un buen piloto no solo pisa el acelerador, lo domina.<br/> Prepárate para afinar tus habilidades de comunicación con la máquina y dar las órdenes que te llevarán directo a la victoria.<br/>", duration: 497, muxPlaybackId: muxPlaybackIds["TIAM01L04"] ?? "", blocked: true },
                        { id: "TIAPM01L05", title: "Introducción al DISEÑO de PROMPTS - Parte 2", longTitle: "Introducción al DISEÑO de PROMPTS - Parte 2 - Dominio de PROMPTS | TRENNO IA", description: "¡Eleva tu juego con la ingeniería de prompts y domina la cancha de la inteligencia artificial! En este video, te convertirás en un verdadero estratega de la IA. Aprenderás a diseñar PROMPTs o instrucciones tan precisas y potentes que transformarán por completo tus resultados. Descubre la fórmula secreta para comunicarte con la inteligencia artificial como un auténtico profesional y llevar tus proyectos al siguiente nivel.<br/> En esta sesión de entrenamiento intensivo, aprenderás a dominar los 6 elementos clave para crear el prompt perfecto:<br/> Sustantivo Clave / Tema (A): Define el campo de juego. Aprenderás a establecer el núcleo de tu solicitud para que la IA se enfoque en lo que realmente importa.<br/> Verbo / Intención (B): Marca la jugada. Descubrirás cómo usar verbos de acción para dirigir a la IA con una intención clara y obtener exactamente lo que necesitas.<br/> Rol (C): Asigna la posición. Aprende a darle a la IA un rol específico para que actúe como un experto en cualquier campo que imagines, desde un profesor de primaria hasta un estratega de marketing.<br/> Forma / Salida / Respuesta (D): Diseña la victoria. Define el formato en el que quieres recibir la información, ya sea un cuento, un correo electrónico, un análisis detallado o cualquier otra cosa que necesites para ganar.<br/> Contexto Infinito (E): Controla el balón. Descubre cómo proporcionar el contexto necesario para que la IA entienda la situación completa y te ofrezca respuestas más ricas y relevantes.<br/> Adjetivo (F): Añade tu estilo. Aprende a usar adjetivos para darle a la respuesta de la IA el tono y la personalidad que desees, desde creativo y mágico hasta profesional y directo.<br/> ¡Prepárate para desatar todo tu potencial! Con estas técnicas, dejarás de ser un espectador y te convertirás en un jugador clave en el mundo de la inteligencia artificial. ¡Es hora de jugar para ganar", duration: 585, muxPlaybackId: muxPlaybackIds["TIAM01L05"] ?? "", blocked: true },
                        { id: "TIAPM01L06", title: "Comprender la INTERFAZ de ChatGPT", longTitle: "Comprender la INTERFAZ de ChatGPT - Dominio de PROMPTS | TRENNO IA", description: "Sin descripción.", duration: 434, muxPlaybackId: muxPlaybackIds["TIAM01L06"] ?? "", blocked: true },
                        { id: "TIAPM01L07", title: "Ejercicio: \"UN LIBRO\"", longTitle: "Ejercicio: \"UN LIBRO\" - Dominio de PROMPTS | TRENNO IA", description: "¡Prepárate para llevar tus interacciones con la IA al siguiente nivel! Este video es tu campo de entrenamiento para convertirte en un verdadero maestro del Prompt Engineering con ChatGPT.<br/> ¿Listo para una sesión intensiva? Aquí aprenderás a construir prompts que no solo obtengan respuestas, sino que te brinden soluciones accionables y personalizadas, como si tuvieras un equipo de expertos dedicados.<br/> Descubre cómo optimizar tu juego:<br/> Define tu Sustantivo Clave/Tema: La base de tu estrategia. ¿Sobre qué quieres que la IA se concentre?<br/> Marca tu Verbo/Intención: No es solo preguntar, es dirigir la acción. ¿Qué acción específica quieres que realice la IA?<br/> Asigna un Rol: Transforma la IA en un experto aliado. ¿Quieres que actúe como un especialista en marketing digital, un autor o incluso un amigo?<br/> Perfecciona la Forma/Salida/Respuesta: Diseña la presentación. Desde rankings detallados hasta resúmenes por capítulos, la forma de la respuesta es clave para su utilidad.<br/> Añade Contexto Infinito: La profundidad es poder. Cuantos más detalles y matices le des, más relevante y adaptada será la respuesta a tus necesidades específicas (por ejemplo, cómo implementar una estrategia de marketing en tu propia empresa).<br/> Incluye Adjetivos: Dale el toque final. ¿Qué tan creativo, práctico o directo quieres que sea el resultado?<br/> Observa la evolución en acción: Desde una búsqueda básica hasta un plan de implementación detallado de 3 semanas, con roles, tareas diarias y consejos específicos para tu equipo. Este video demuestra cómo cada capa de un prompt bien diseñado te acerca a la perfección en la productividad y la estrategia.<br/> ¡Es hora de entrenar a tu IA como un campeón! Aplica estas técnicas y transforma la forma en que trabajas.<br/>", duration: 582, muxPlaybackId: muxPlaybackIds["TIAM01L07"] ?? "", blocked: true },
                    ],
                    instructions: []
                },
                {
                    ...
                    description: "Conviertete en un experto en la personalización de ChatGPT.",
                    lessons: [
                        { id: "TIAPM02L01", title: "Preparando el contexto para empezar a PERSONALIZAR", longTitle: "Preparando el contexto para empezar a PERSONALIZAR - Personalización de ChatGPT | TRENNO IA", description: "¡Entrena a tu IA, Conquista tus Metas!<br/> ¡Prepárate para llevar tu juego al siguiente nivel! En esta sesión, nos sumergimos de lleno en el Dominio 2: Saber Personalizar. Ya no se trata solo de usar la inteligencia artificial, sino de convertirla en tu aliada estratégica más poderosa.<br/> Descubre cómo transformar a tu asistente de IA en un verdadero copiloto de alto rendimiento, un experto que conoce tu visión, tu misión y tus objetivos tan bien como tú. Aprenderás a alimentar el chat con la información clave de tu negocio, desde tu propuesta de valor hasta el perfil de tu cliente ideal, para que cada respuesta sea un paso más hacia la victoria.<br/> Este no es un entrenamiento cualquiera; es el comienzo de tu camino para convertirte en un verdadero entrenador de IA. Si estás listo para dejar de ser un simple usuario y empezar a liderar con tecnología, ¡dale al play y comencemos a construir tu legado<br/>", duration: 437, muxPlaybackId: muxPlaybackIds["TIAM02L01"] ?? "", blocked: true },
                        { id: "TIAPM02L02", title: "Cómo personalizar a ChatGPT Parte 1", longTitle: "Cómo personalizar a ChatGPT Parte 1 - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 420, muxPlaybackId: muxPlaybackIds["TIAM02L02"] ?? "", blocked: true },
                        { id: "TIAPM02L03", title: "Cómo personalizar a ChatGPT Parte 2", longTitle: "Cómo personalizar a ChatGPT Parte 2 - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 584, muxPlaybackId: muxPlaybackIds["TIAM02L03"] ?? "", blocked: true },
                        { id: "TIAPM02L04", title: "Ejercicio: \"Desarrollar información clave del negocio con IA\"", longTitle: "Ejercicio: \"Desarrollar información clave del negocio con IA\" - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 413, muxPlaybackId: muxPlaybackIds["TIAM02L04"] ?? "", blocked: true },
                        { id: "TIAPM02L05", title: "Instrucciones PERSONALIZADAS de ChatGPT", longTitle: "Instrucciones PERSONALIZADAS de ChatGPT - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 597, muxPlaybackId: muxPlaybackIds["TIAM02L05"] ?? "", blocked: true },
                        { id: "TIAPM02L06", title: "Estructura básica de generación de prompts: Fórmula RACS", longTitle: "Estructura básica de generación de prompts: Fórmula RACS - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 576, muxPlaybackId: muxPlaybackIds["TIAM02L06"] ?? "", blocked: true },
                        { id: "TIAPM02L07", title: "Personalización de áreas del negocio: Área Marketing", longTitle: "Personalización de áreas del negocio: Área Marketing - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 554, muxPlaybackId: muxPlaybackIds["TIAM02L07"] ?? "", blocked: true },
                        { id: "TIAPM02L08", title: "Personalización de áreas del negocio: Área Ventas", longTitle: "Personalización de áreas del negocio: Área Ventas - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 546, muxPlaybackId: muxPlaybackIds["TIAM02L08"] ?? "", blocked: true },
                        { id: "TIAPM02L09", title: "Roles en el área de ventas", longTitle: "Roles en el área de ventas - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 545, muxPlaybackId: muxPlaybackIds["TIAM02L09"] ?? "", blocked: true },
                        { id: "TIAPM02L10", title: "Exploración de ROLES: El principio de los Asistentes virtuales", longTitle: "Exploración de ROLES: El principio de los Asistentes virtuales - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 499, muxPlaybackId: muxPlaybackIds["TIAM02L10"] ?? "", blocked: true },
                        { id: "TIAPM02L11", title: "Tipologías de PROMPTs", longTitle: "Tipologías de PROMPTs - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 571, muxPlaybackId: muxPlaybackIds["TIAM02L11"] ?? "", blocked: true },
                        { id: "TIAPM02L12", title: "Recomendaciones para dar INDICACIONES a la IA: EL VERBO", longTitle: "Recomendaciones para dar INDICACIONES a la IA: EL VERBO - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 229, muxPlaybackId: muxPlaybackIds["TIAM02L12"] ?? "", blocked: true },
                        { id: "TIAPM02L13", title: "Cómo DELEGAR: Fórmula RODOIR", longTitle: "Cómo DELEGAR: Fórmula RODOIR - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 572, muxPlaybackId: muxPlaybackIds["TIAM02L13"] ?? "", blocked: true },
                        { id: "TIAPM02L14", title: "Profundizar sobre las FORMAS de RESPUESTAS al diseñar PROMPTs", longTitle: "Profundizar sobre las FORMAS de RESPUESTAS al diseñar PROMPTs - Personalización de ChatGPT | TRENNO IA", description: "Sin descripción.", duration: 580, muxPlaybackId: muxPlaybackIds["TIAM02L14"] ?? "", blocked: true },
                    ],
                    instructions: []
                },
            ],
