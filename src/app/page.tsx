  ...
  return (
    <main className="w-full flex justify-center">
      ...
      <section className="w-full max-w-3xl min-h-svh p-4 lg:p-12 lg:bg-gradient-to-r lg:from-background lg:to-card/40 text-center flex flex-col justify-center items-center relative z-50">
        ...
        <Link href={'/login'} className="mt-2 w-full max-w-lg h-12 bg-stannum hover:bg-stannum-light rounded text-card lg:text-lg font-semibold flex justify-center items-center transition-200">
          Iniciar sesión
        </Link>
        <p className="mt-8 subtitle-1 text-base lg:text-lg text-white">O regístrate gratis ahora</p>
        <Link href={'/register'} className="mt-2 w-full max-w-lg h-12 bg-card-light lg:bg-card hover:bg-card-lighter lg:hover:bg-card-light rounded lg:text-lg font-semibold flex justify-center items-center transition-200">
          Regístrarme ahora
        </Link>
        <div className="mt-12 w-full max-w-lg flex justify-center items-center gap-4">
