...
import { GoogleAuthUsername } from "@/components";
...
export default function RegisterGooglePage() {
    return (
        <main className="grow w-full flex flex-col items-center bg-card relative">
            <h1 className="sr-only">Registrate gratis en STANNUM Game usando Google</h1>
            <div className="w-full min-h-svh absolute top-0 left-0">
                <div className="w-full min-h-svh fixed">
                    <Image src={background} draggable={false} alt='Registrate gratis en STANNUM Game usando Google' className="size-full object-cover blur-sm absolute top-0 left-0"/>
                </div>
            </div>
            <GoogleAuthUsername/>
        </main>
