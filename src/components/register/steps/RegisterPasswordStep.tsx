    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="w-full">
            <div className='w-full flex flex-col gap-1'>
                <label htmlFor="username" className="text-white text-lg">Elige tu nombre de usuario.</label>
                <div className="w-full flex">
                    <div className="size-9 bg-card-lighter flex justify-center items-center rounded-s">
                        <CiAt className="text-neutral-400 stroke-1 text-lg"/>
                    </div>
            ...
            <div className='mt-6 w-full flex flex-col gap-1 relative'>
                <label htmlFor="password" className="text-white text-lg">Ahora crea tu contraseña!</label>
                <input
                    ...
                    className="peer w-full h-9 px-2 bg-card-light text-white rounded-t"
                    {...register("password",{
                        required: true,
                        minLength: 6,
                        maxLength: 25
