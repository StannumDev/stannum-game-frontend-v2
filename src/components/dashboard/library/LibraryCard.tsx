...
export const LibraryCard = () => {
    ...
    return (
        <Link href={'/dashboard/library/tmd'} className="w-full aspect-square lg:aspect-[3/4] rounded-lg border border-card lg:hover:border-card-light flex flex-col overflow-hidden group relative">
            ...
            <div className='w-full grow flex flex-col p-6 lg:bg-card lg:group-hover:bg-card-light z-20'>
                <div className='w-full grow flex flex-col justify-center items-center'>
                    <Image src={logo} alt='Programa STANNUM Game' className='w-52 lg:w-48'/>
                    <p className='hidden lg:block mt-4 px-12 text-center text-pretty'>Aprende a profesionalizar tu equipo de venta y marketing.</p>
                </div>
                <div className='mt-6 lg:mt-0 w-full p-6 lg:p-0 flex justify-center items-center gap-2 absolute lg:static bottom-0 left-0'>
