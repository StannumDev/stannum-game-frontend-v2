...
export const UserProfileInfo = ({user, fetchUserData, owner}:Props) => {
    return (
        <div className="w-full flex flex-wrap gap-4">
            <section id="profile-info" className="w-full lg:w-[calc((100%/3)*2-16px)] card relative">
            ...
            <section id="profile-about" className="w-full lg:w-1/3 min-h-32 max-h-96 lg:h-auto card flex flex-col gap-4">
