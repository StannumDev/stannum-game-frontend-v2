...
export const UserProfileCover = () => {
    return (
        <div className="w-full card rounded-b-none border-b-0 p-0 overflow-hidden relative group/main">
            ...
            <button type="button" className="size-8 rounded-md flex justify-center items-center bg-card-light hover:bg-card-lighter group/container opacity-0 group-hover/main:opacity-100 absolute top-6 right-6 z-20 transition-200">
