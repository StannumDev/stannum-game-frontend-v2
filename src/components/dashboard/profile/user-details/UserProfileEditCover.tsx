            ...
            >
                <div className="w-full">
                    <div className="w-full card rounded-b-none p-0 overflow-hidden relative">
                        ...
                        <Image priority src={getCoverImage(`cover_${selectedId}`)} alt="Preview portada" className="w-full aspect-video lg:aspect-auto lg:h-96 object-cover relative z-0 object-[50%_65%]" />
                    </div>
