        ...
        <Fragment>
            ...
            >
                <div className="w-full flex flex-col justify-center items-center text-center">
                    ...
                    <p className="mt-4 text-xs font-semibold uppercase tracking-widest text-card-lightest">No podras deshacer esta acción. Sin embargo, eres libre de agregar una foto nueva de perfil en cualquier momento.</p>
