...
export const UserProfilePicture = () => {
    return (
        <div className="size-24 lg:size-48 bg-gradient-to-br from-card to-card-light rounded-lg lg:rounded-2xl shadow-md relative overflow-hidden z-10 group/picture outline outline-2 outline-stannum">
            <Image priority src={mateo} alt="Perfil de usuario STANNUM Game" className="size-full object-cover absolute top-0 left-0"/>
