...
export const UserProfilePicture = () => {
    return (
        <div className="size-24 lg:size-48 rounded-lg lg:rounded-2xl shadow-md relative overflow-hidden z-10 group/picture">
            ...
            <button type="button" className="size-8 rounded-md hidden lg:flex justify-center items-center bg-card-light hover:bg-card-lighter group/container opacity-0 group-hover/picture:opacity-100 absolute top-4 right-4 z-20 transition-200">
