...
export const ProgramCompletedModuleCard = ({index, title}:Props) => {
    return (
        <div className='w-full h-16 bg-stannum/40 hover:bg-stannum/50 text-stannum flex items-center rounded-lg relative overflow-hidden group cursor-pointer transition-200'>
