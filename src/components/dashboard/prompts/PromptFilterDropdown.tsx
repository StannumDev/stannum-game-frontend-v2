...
export const PromptFilterDropdown = ({ label, placeholder, options, value, onChange, multi = false }: Props) => {
                        ...
                        <div className="flex items-center justify-between px-2 pb-1">
                            ...
                            {selectedCount > 0 &&
                                <button
                                    type="button"
                                    onClick={clearAll}
                                    className="text-[11px] underline text-card-lighter hover:text-invalid transition-200"
                                >
                                    Limpiar
                                </button>
                            }
