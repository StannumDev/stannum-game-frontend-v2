...
const schema = z.object({
    ...
    customGptUrl: z.string().url('Debe ser una URL válida').trim().optional().or(z.literal('')),
    tags: z.array(z.string().min(2, 'Cada tag debe tener al menos 2 caracteres').max(30, 'Cada tag no puede exceder 30 caracteres').regex(/^[a-záéíóúüñ0-9\s\-_.]+$/, 'Solo se permiten letras, números, guiones, guiones bajos, puntos y espacios')).max(10, 'No puedes agregar más de 10 tags').default([]),
    exampleOutput: z.string().max(2000, 'El ejemplo no puede exceder 2000 caracteres').trim().optional(),
});
                ...
                >
                    <form className="p-6 space-y-6">
                        <div className="flex items-center justify-between pb-4 border-b border-card-light">
                            <div>
                                <h2 className="text-2xl font-bold">Cargar un Prompt</h2>
                        ...
                        <div className="w-full grid grid-cols-1 gap-4">
                            ...
                            <div className="w-full">
                                ...
                                {errors.content && <p className="text-invalid text-xs mt-1">{errors.content.message}</p>}
                            </div>
                            <div className="w-full">
                                    ...
                                    {platformOptions.map((platform) => {
                                        ...
                                        return (
                                            <motion.button
                                                ...
                                                disabled={isLoading}
                                                className={`px-3 py-2 rounded-lg border text-sm font-medium transition-all disabled:opacity-50 flex items-center gap-2 ${
                                                    isSelected 
                                                        ? 'bg-stannum/20 border-stannum text-stannum' 
                                                        : 'bg-card border-card-light hover:border-card-lighter'
                                                }`}
                            ...
                            <div className="w-full">
                                ...
                                {errors.customGptUrl && <p className="text-invalid text-xs mt-1">{errors.customGptUrl.message}</p>}
                            </div>
                            <div className="w-full">
                            ...
                            <div className="w-full">
                                ...
                                {errors.exampleOutput && <p className="text-invalid text-xs mt-1">{errors.exampleOutput.message}</p>}
                            </div>
                        </div>
