            ...
            <MotionWrapperLayout className="order-3 lg:order-none">
                <button
                    ...
                    <div className="w-full relative z-20">
                        ...
                        <p className="mt-2 w-full text-sm lg:text-base"><b className="text-stannum">Ingresa tu clave</b> de producto y comenza a <span className="block">disfrutar tu producto al máximo.</span></p>
                    </div>
            ...
            >
                <div className="size-full flex flex-col lg:flex-row rounded-lg divide-card divide-x">
                    ...
                    <main className="w-full lg:max-w-[calc(384px+4rem)] p-6 lg:p-8 flex flex-col text-center lg:text-start">
                        <h2 className="title-2 text-4xl sm:text-5xl text-stannum">Activa un <span className="block text-white">producto</span></h2>
