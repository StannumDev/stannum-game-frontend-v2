    ...
    return (
        <section className="w-full card">
            <div className="w-full flex justify-between items-center">
                ...
                <Link href={'/'} className="w-fit px-2.5 lg:px-4 py-1 text-sm lg:text-lg rounded-lg border border-card-light relative group hover:bg-card-light transition-all duration-200 ease-in-out">
