            ...
            <div ref={introRef} className='w-full'>
                <MotionWrapperLayout>
                    ...
                    >
                        ...
                        <button type="button" aria-label="Reproducir" className="size-14 2xl:size-24 rounded-full bg-white/25 flex justify-center items-center absolute 2xl:relative bottom-6 lg:top-6 2xl:bottom-0 right-6 2xl:right-0 z-30 group-hover:scale-125 transition-200">
