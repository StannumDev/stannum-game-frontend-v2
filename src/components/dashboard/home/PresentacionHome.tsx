    ...
    return (
        <MotionWrapperLayout>
            <section className="w-full card aspect-video flex justify-center items-start lg:items-center relative overflow-hidden group ">
                ...
                <button type="button" className="size-14 lg:size-32 rounded-full bg-stannum flex justify-center items-center absolute lg:relative bottom-6 lg:bottom-0 right-6 lg:right-0 z-20 hover:scale-105 transition-200" >
                    <IoPlaySharp className="size-8 lg:size-16 relative left-1 lg:left-2"/>
                </button>
                <Image src={stannum_game_video} priority alt="Presentación STANNUM Game" className="size-full object-cover blur-[1px] absolute top-0 left-0 z-0"/>
