            ...
            <div className='w-full relative z-20 overflow-hidden'>
                ...
                </div>
                {
                    ...
                    <div className='mt-2 flex justify-center items-center gap-2'>
                        ...
                        <div className="w-full h-1.5 bg-white rounded-lg flex overflow-hidden transition-all duration-200 ease-in-out" role="progressbar" aria-valuenow={progress} aria-valuemin={0} aria-valuemax={100}>
